...
enum PonllyponllTornEdge {
    ...
    static var babruCiuPaintPeelttles: [PonllyBattle] = {
        let brushMarker = [
            PonllyaerErstSolidMarkerk(graffitiPulse: "a01", markerStroke: "u01", nozzleCraft: "Ubncddeerfpgahsisj kClhmrnoompeq rEsdtguev".ponllPaintaerErstHours, capControl: "CwhxryozmAeB".ponllPaintaerErstHours, stencilBloom: "warehouseWall", inkDrift: [.systemPink, .cyan, .darkGray]),
            PonllyaerErstSolidMarkerk(graffitiPulse: "a02", markerStroke: "u02", nozzleCraft: "PCaDsEtFeGlH IBJlKoLcMkN OFPlQoRwS".ponllPaintaerErstHours, capControl: "CThUrVoWmXeY".ponllPaintaerErstHours, stencilBloom: "brickFacade", inkDrift: [.cyan, .gray, .black]),
            PonllyaerErstSolidMarkerk(graffitiPulse: "a03", markerStroke: "u03", nozzleCraft: "BZr0i1c2k3 4L5a6y7e8r9 aWbiclddesftgyhliej".ponllPaintaerErstHours, capControl: "Wkillmdnsotpyqlres".ponllPaintaerErstHours, stencilBloom: "shutterPanel", inkDrift: [.green, .systemPink, .black]),
            PonllyaerErstSolidMarkerk(graffitiPulse: "a04", markerStroke: "u04", nozzleCraft: "Ltaunvewwxayyz ACBoClDoErF GWHaIlJlK".ponllPaintaerErstHours, capControl: "CLhMaNrOaPcQtReSrT".ponllPaintaerErstHours, stencilBloom: "paintedFence", inkDrift: [.cyan, .systemPink, .yellow]),
