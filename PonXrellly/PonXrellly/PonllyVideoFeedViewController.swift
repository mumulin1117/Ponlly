...
@MainActor
final class PonllyVideoFeedViewController: UIViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        collectionView.visibleCells.compactMap { $0 as? PonllyVideoFeedCell }.forEach { $0.pause() }
    }
    ...
    private func setupCollection() {
        ...
        collectionView.register(PonllyVideoFeedCell.self, forCellWithReuseIdentifier: PonllyVideoFeedCell.reuseId)
    ...
    func playCenteredCell() {
        ...
        if let indexPath = collectionView.indexPathForItem(at: center),
           let cell = collectionView.cellForItem(at: indexPath) as? PonllyVideoFeedCell {
            cell.play()
        }
    }
    ...
    func updatePlaybackForVisibleCells() {
        ...
        collectionView.visibleCells.compactMap { $0 as? PonllyVideoFeedCell }.forEach { cell in
