...
final class PonllyCreateVoiceRoomViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, UITextViewDelegate {
    ...
    @objc private func nextTapped() {
        ...
        navigationController?.pushViewController(PonllyVoiceThemeStoreViewController(draft: draft), animated: true)
    }
